        ...
        <>
          <div className="cart__item">
            <div className="cart__wrapper">
              <p className="cart__delete__text">
                Удаление {item.title} через {count}...
              </p>
              <p onClick={handleReturnClick} className="cart__delete__text">
                Вернуть
              </p>
            </div>
          </div>
        ...
        <>
          <div className="cart__item">
            <div className="item__img">
              <img
                src={`http://13.51.165.176${item.image.image}`}
                alt="product"
              />
            </div>
            ...
            <div className="item__counter">
              <img
                onClick={() => handleRemoveOneCount(item)}
                src="/minus.svg"
                alt="-"
              />
              <p>{item.quantity}</p>
