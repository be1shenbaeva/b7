...
const Modal = ({ isOpen, closeModal }) => {
  ...
  return (
    <div
      className={`${isOpen ? 'modal__wrapper modal__active' : 'modal__wrapper'}`}
      onClick={closeModal}
    >
      ...
      <div
        className={`${isOpen ? 'modal-content modal-content-active' : 'modal-content'}`}
      ...
      >
        ...
        <div className="inputs__wrapper">
          ...
          <button
            onClick={handleOrder}
            className="mt-4 w-full rounded-xl bg-blue-600 p-4 px-4 font-bold text-white"
          >
            Оформить заказ
          </button>
        </div>
